...
BOT_NAME = "Bot A"
DB_NAME = "winners_a.db"
CSV_FILE = "codes_part1.csv"
...
REQUIRED_CHANNELS = os.environ.get('REQUIRED_CHANNELS_A', '')
...
def main():
    """Start Bot A with webhook"""
    bot_token = os.environ.get('BOT_TOKEN_A')
    
    if not bot_token:
        print(f"❌ Error: BOT_TOKEN_A environment variable not set!")
